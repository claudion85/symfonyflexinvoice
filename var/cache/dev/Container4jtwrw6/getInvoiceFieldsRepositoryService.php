...
// Returns the private 'App\Repository\InvoiceFieldsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InvoiceFieldsRepository.php';

return $this->services['App\\Repository\\InvoiceFieldsRepository'] = new \App\Repository\InvoiceFieldsRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
