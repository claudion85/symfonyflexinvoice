...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\InvoiceFieldsRepository' => function () {
    return ${($_ = isset($this->services['App\\Repository\\InvoiceFieldsRepository']) ? $this->services['App\\Repository\\InvoiceFieldsRepository'] : $this->load('getInvoiceFieldsRepositoryService.php')) && false ?: '_'};
