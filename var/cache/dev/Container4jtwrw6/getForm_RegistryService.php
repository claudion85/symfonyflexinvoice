...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Form\\InvoiceFieldsType' => function () {
    return ${($_ = isset($this->services['App\\Form\\InvoiceFieldsType']) ? $this->services['App\\Form\\InvoiceFieldsType'] : ($this->services['App\\Form\\InvoiceFieldsType'] = new \App\Form\InvoiceFieldsType())) && false ?: '_'};
}, 'App\\Form\\InvoiceType' => function () {
    return ${($_ = isset($this->services['App\\Form\\InvoiceType']) ? $this->services['App\\Form\\InvoiceType'] : ($this->services['App\\Form\\InvoiceType'] = new \App\Form\InvoiceType())) && false ?: '_'};
